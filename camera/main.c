...
char NAVIGATION(int word, int * top_1, int * top_3, int * bottom_1, int * bottom_3) {
	int id = word >> 28;
	...
	if (id == 6){
		...
		* bottom_1 = data_1;
		...
		else if ((gradient_l > 0.74*16) & (gradient_l < 1.2*16)) {
			dir = 'f';
			//printf("%c ", dir);
		}
		else {
		...
		* bottom_3 = data_1;
		...
		else if ((gradient_r > 0.74*16) & (gradient_r < 1.2*16)) {
			dir = 'f';
			//printf("%c ", dir);
		}
		else {
  ...
  while(1){
       ...
       while ((IORD(0x42000,EEE_IMGPROC_STATUS)>>8) & 0xff) { 	//Find out if there are words to read
		   while(1){
			...
			if ((word>>28)==0) {
		        word_1 = (word, & top_1, & top_3, & bottom_1, & bottom_3);
				break;
			}
		   }
		   ...
		   while(1){
			if ((IORD(0x42000,EEE_IMGPROC_STATUS)>>8) & 0xff) {
		        ...
		        word_2 = (word, & top_1, & top_3, & bottom_1, & bottom_3);
				break;
			}
		   }
		   ...
		   while(1){
			if ((IORD(0x42000,EEE_IMGPROC_STATUS)>>8) & 0xff) {
				word = IORD(0x42000,EEE_IMGPROC_MSG); 			//Get next word from message buffer
		        word_3 = (word, & top_1, & top_3, & bottom_1, & bottom_3);
				break;
			}
		   }
		   ...
		   while(1){
			if ((IORD(0x42000,EEE_IMGPROC_STATUS)>>8) & 0xff) {
				word = IORD(0x42000,EEE_IMGPROC_MSG); 			//Get next word from message buffer
		        word_4 = (word, & top_1, & top_3, & bottom_1, & bottom_3);
				break;
			}
		   }
		   ...
		   while(1){
			if ((IORD(0x42000,EEE_IMGPROC_STATUS)>>8) & 0xff) {
				word = IORD(0x42000,EEE_IMGPROC_MSG); 			//Get next word from message buffer
		        word_5 = (word, & top_1, & top_3, & bottom_1, & bottom_3);
				break;
			}
		   }
		   ...
		   while(1){
			if ((IORD(0x42000,EEE_IMGPROC_STATUS)>>8) & 0xff) {
				word = IORD(0x42000,EEE_IMGPROC_MSG); 			//Get next word from message buffer
		        word_6 = (word, & top_1, & top_3, & bottom_1, & bottom_3);
				break;
			}
		   }
		   ...
		   while(1){
			if ((IORD(0x42000,EEE_IMGPROC_STATUS)>>8) & 0xff) {
				word = IORD(0x42000,EEE_IMGPROC_MSG); 			//Get next word from message buffer
		        word_7 = (word, & top_1, & top_3, & bottom_1, & bottom_3);
				break;
			}
		   }
